...
{	
    ...
    /*if ([selectedAssetsImages count]>_MaxSelectedImages || _MaxSelectedImages == 0) {
        [self.parent selectedAssets:selectedAssetsImages];
    }
    else
    {
        NSString *errorMessage = [NSString stringWithFormat:@"You can selected only %d image.",_MaxSelectedImages];
        [UIAlertView ATAlertWithError:errorMessage CancelButtonTitle:@"OK" ALertTitle:AppName];
    }*/
    [self.parent selectedAssets:selectedAssetsImages];
}
